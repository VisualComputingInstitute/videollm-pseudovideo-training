...
copied_batch_file=${copy_code_to}/scripts/julich/sbatch_train_zero3_offl.sh
...
"./pretr_checkpoints/cambrian/LongVU_Qwen2_7B_img" \
...
${s}\"./data_configs/splicing/q1_complexity_ablations/q1_max_20fr_per_sc.yaml${s}\"}")
