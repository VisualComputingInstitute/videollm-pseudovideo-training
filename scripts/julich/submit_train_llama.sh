...
data_args=("--dataset_type" "linear_motion" \
"--repeat_first_frame_only" "False" \
"--dataset_kwargs_as_dict_str" \
"{${s}\"video_yaml_path${s}\": \
${s}\"./data_configs/vid_complexity/vid_complexity2_julich.yaml${s}\", \
${s}\"question_yaml_path${s}\": \
${s}\"./data_configs/question_complexity/counting_only.yaml${s}\"}")
