...
class CambrianLlamaForCausalLM(LlamaForCausalLM, CambrianMetaForCausalLM):
    ...
    @torch.no_grad()
    def get_highres_aligned_tokens(
        self,
        ...
        **kwargs,
        ...
        if images is not None:
            return self._get_highres_aligned_tokens(
                inputs,
                position_ids,
                attention_mask,
                None,
    ...
    def generate(
        ...
        images: Optional[torch.Tensor] = None,
        image_sizes: Optional[torch.Tensor] = None,
        also_return_aligned_embeds: bool=False,
        **kwargs,
        ...
        if images is not None:
            if(not also_return_aligned_embeds):
                (
                    inputs,
                    position_ids,
                    attention_mask,
                ...
                (
                    ...
                    images,
                    image_sizes=image_sizes,
                    also_return_aligned_embeds=True)                
        ...
        if(not also_return_aligned_embeds):
            ...
            return (ret,) + (
                selected_frame_inds, aligned_highres_toks, inputs_embeds)
